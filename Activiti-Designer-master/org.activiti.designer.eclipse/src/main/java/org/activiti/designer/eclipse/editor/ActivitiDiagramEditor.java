...
public class ActivitiDiagramEditor extends DiagramEditor {
  ...
  private void marshallImage(BpmnMemoryModel model, String modelFileName) {
    try {
      //TODO: Ha
      //DiagramEditor diagramEditor = (DiagramEditor)model.getFeatureProvider().getDiagramTypeProvider().getDiagramEditor();
    	DiagramEditor diagramEditor = (DiagramEditor)model.getFeatureProvider().getDiagramTypeProvider().getDiagram();
